 ...
 * @email
 */
public class All_Test_Case extends BaseTester{
	
	@DataProvider
	public Object[][] datas(){
		
		List<ExcelObject> objectList = (List<ExcelObject>) ExcelUtils.readExcel("/api.xlsx",2, ApiDetail.class);
	...
	public void test_case(String caseId,String apiId,String requestData,String expectedReponseData,
		...
		Assert.assertEquals(actualResult, expectedReponseData);
	}
}
